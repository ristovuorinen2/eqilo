      ...
      <div className="container py-12 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm text-muted-foreground">
              Modern timekeeping devices from Swiss manufacturer FDS Timing. Eqilo provides over 20 years of expertise to Finnish agility and equestrian clubs.
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link href="/shop" className="text-muted-foreground hover:text-foreground">All Products</Link>
              </li>
              <li>
                <Link href="/services" className="text-muted-foreground hover:text-foreground">Services & Consulting</Link>
              </li>
              <li>
        ...
        <div className="mt-12 pt-8 border-t flex flex-col md:flex-row items-center justify-between gap-4 text-xs text-muted-foreground">
          ...
          <div className="flex gap-4">
            <span className="font-medium text-primary">Standard Shipping: 1-2 Weeks</span>
          </div>
        </div>
      </div>
    </footer>
