...
const dictionaries: Record<Language, TranslationDictionary> = {
  FI: {
    ...
    "cookie.desc": "Käytämme evästeitä parantaaksemme sivuston käyttökokemusta, tarjotaksemme kohdennettua sisältöä ja analysoidaksemme liikennettä. Klikkaamalla \"Hyväksy kaikki\" hyväksyt evästeiden käytön.",
