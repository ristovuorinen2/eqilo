...
graph TD
    ...
    Backend -->|Product Sync| FdsTiming[fdstiming.com API]
...
- `POST /api/admin/sync-products` - Fetches and updates product catalog from fdstiming.com.
...
2. **Phase 2: Admin & Catalog Sync** - Build the fdstiming.com integration to populate the `products` collection. Create Admin views.
...
- Manual verification of product sync from fdstiming.com.

## Migration & Rollback
- Since this is a greenfield project, initial migration involves one-time syncing from fdstiming.com.
